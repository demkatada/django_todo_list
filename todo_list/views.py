...
def home(request):
	return render(request, 'home.html', {'user': "demkatada"})
def about(request):
	my_name = "Dominic Enrique Mercado Katada"
	return render(request, 'about.html', {"myname": my_name})
def contact(request):
	return render(request, 'contact-us.html', {'user': "demkatada"})
def listings(request):
	if request.method == 'POST':
	    ...
	    if form.is_valid():
	        ...
	        context = {'all_items': all_items, "user": "demkatada"}
